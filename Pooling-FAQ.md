- [General FAQ](#general-faq)
  * [When will Chia official pooling software be released?](#when-will-chia-official-pooling-software-be-released-)
  * [Will I need to replot to use the official pooling protocol?](#will-i-need-to-replot-to-use-the-official-pooling-protocol-)
  * [Will I need pay XCH to switch pools?](#will-i-need-pay-xch-to-switch-pools-)
  * [Can I farm with both OG (original) plots and portable plots?](#can-i-farm-with-both-og--original--plots-and-portable-plots-)
  * [When can I start creating portable plots?](#when-can-i-start-creating-portable-plots-)
  * [What is this new portable pool thing called?](#what-is-this-new-portable-pool-thing-called-)
  * [How can I start my own pool?](#how-can-i-start-my-own-pool-)
  * [Where can I find a list of Chia pools?](#where-can-i-find-a-list-of-chia-pools-)
  * [Can I advertise my pool in Keybase?](#can-i-advertise-my-pool-in-keybase-)
  * [Why shouldn't I join Hpool?](#why-shouldn-t-i-join-hpool-)
  * [Why doesn't Chia run their own official pool?](#why-doesn-t-chia-run-their-own-official-pool-)
  * [Can I name my pool chiapool.com?](#can-i-name-my-pool-chiapoolcom-)
  * [If a pool gets 51% of netspace, can they take over the network?](#if-a-pool-gets-51--of-netspace--can-they-take-over-the-network-)
  * [I have more questions, where do I ask?](#i-have-more-questions--where-do-i-ask-)
- [Technical FAQ](#technical-faq)
  * [Why isn't the pool reference code working?](#why-isn-t-the-pool-reference-code-working-)
  * [What programming language is the reference pool code written in?](#what-programming-language-is-the-reference-pool-code-written-in-)
  * [How hard is it to adapt Chia's reference pool code to my pool code?](#how-hard-is-it-to-adapt-chia-s-reference-pool-code-to-my-pool-code-)
  * [I am a programmer, but never wrote pool code, will I be able to run a pool with Chia's reference pool code?](#i-am-a-programmer--but-never-wrote-pool-code--will-i-be-able-to-run-a-pool-with-chia-s-reference-pool-code-)
  * [How does one calculate a farmer's netspace?](#how-does-one-calculate-a-farmer-s-netspace-)
  * [How does difficulty affect farmer's nestpace calculation?](#how-does-difficulty-affect-farmer-s-nestpace-calculation-)
  * [How do you identify the farmer that submitted partial proofs?](#how-do-you-identify-the-farmer-that-submitted-partial-proofs-)
  * [Will pool servers need to keep track of all farmers and their share of rewards?](#will-pool-servers-need-to-keep-track-of-all-farmers-and-their-share-of-rewards-)
  * [What are the API methods a pool server needs to support Chia clients?](#what-are-the-api-methods-a-pool-server-needs-to-support-chia-clients-)
  * [Where can I see the Chia Pool Reference Code?](#where-can-i-see-the-chia-pool-reference-code-)
...
- [Draft FAQ Items](#draft-faq-items)
  * [How do pool collect rewards?](#how-do-pool-collect-rewards-)
  * [What actions can singleton take?](#what-actions-can-singleton-take-)
