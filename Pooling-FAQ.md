...
We are not going to allow pools to use "Chia" as the first word or its equivalent (the chia pool). You can say things like "a Chia pool" though that will probably need a free and easy to get license. Ask in Keybase @chia_network.public#pools for more information on obtaining a license.
