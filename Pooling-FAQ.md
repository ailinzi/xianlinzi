...
* Will be implemented as fast follow after Pooling 1.0 is released *: https://trello.com/c/5goJUups/1180-felixbrucker-create-rpc-calls-in-full-node-to-process-clvm-needed-by-reference-pool-code
